<template>
  <div>
    <h1 class="text-3xl mb-10">Admin Panel</h1>
    <div>
      <h3 class="text-xl">All Posts</h3>
      <p class="mb-6">Total amount of posts: {{ allPosts.length }}</p>
    ...
    <div>
      ...
      <p class="mb-6">Total amount of users: {{ allUsers.length }}</p>
      <table class="text-center mb-10">
        <tr>
          <th>Username</th>
          <th>Email</th>
    ...
    <div>
      <h3 class="text-xl mb-6">Register User</h3>
